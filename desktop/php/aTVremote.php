...
<legend><i class="fa fa-table"></i>  {{Mes AppleTV}}</legend>
<div class="eqLogicThumbnailContainer">
         <?php
                foreach ($eqLogics as $eqLogic) {
                    $opacity = '';
...
<div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
 ...
 <a class="btn btn-default eqLogicAction pull-right" data-action="configure"><i class="fa fa-cogs"></i> {{Configuration avancée}}</a>
    ...
    <div class="col-sm-6">
     ...
     <div class="form-group">
      <label class="col-sm-3 control-label">{{Ip de l'AppleTV}}</label>
      <div class="col-sm-4">
	    <div class="input-group">
          <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="ip" placeholder="{{Ip de l'AppleTV}}"/><span class="input-group-addon">:</span><input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="port" placeholder="{{port de l'AppleTV}}"/>
		</div>
      </div>
                </div>
				  <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="credentials" placeholder="{{Credentials}}"/>
      </div>
                </div>
            </fieldset>
        </form>
